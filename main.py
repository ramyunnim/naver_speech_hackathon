...
def bind_model(model, optimizer='adam'):
    ...
    def infer(wav_path):
        ...
        input = get_feature_from_librosa(wav_path).unsqueeze(0)
        feature_size = model.DO_NOTHING
...
def main():
    ...
    optimizer = optim.Adam(model.module.parameters(), lr=args.lr, eps=1e-08, weight_decay=0.01)
    ...
    nsml.load(checkpoint='best', session='team199/sr-hack-2019-dataset/250')
